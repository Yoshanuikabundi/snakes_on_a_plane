...
copyright = (
    "2021, Josh Mitchell (Yoshanuikabundi). Project structure based on the "
...
latex_documents = [
    (
        master_doc,
        "snakes_on_a_plane.tex",
        "Snakes on a Plane Documentation",
        "snakes_on_a_plane",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "snakes_on_a_plane", "Snakes on a Plane Documentation", [author], 1)
]
